      ...
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-lg">
        ...
        >
          ...
          <div className="flex justify-end gap-3 mt-8">
            <button
              type="submit"
              className="w-32 py-2 px-4 rounded-lg border-2 border-green-500 text-green-700 font-semibold bg-white hover:bg-green-50 hover:border-green-600 transition-colors duration-200 shadow-sm flex items-center justify-center gap-2"
            >
              <svg
